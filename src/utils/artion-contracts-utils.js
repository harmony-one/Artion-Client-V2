 ...
 */
 function createNFTCollection(nftName, nftSymbol, amount, web3Client, contract = process.env.VUE_APP_HARMONY_NFT_FACTORY_CONTRACT_ADDRESS) {
 ...
 * @return {{to: address, data: string, value string}}
 */
 function createArtCollection(nftName, nftSymbol, amount, web3Client, contract = process.env.VUE_APP_HARMONY_ART_FACTORY_CONTRACT_ADDRESS) {
 ...
 * @return {{to: address, data: string, value string}}
 */
 function registerTokenRoyalty(nftAddress, tokenID, royalty, web3Client, contract = process.env.VUE_APP_HARMONY_MARKETPLACE_CONTRACT_ADDRESS) {
 ...
 * @return {{to: address, data: string, value string}}
 */
 function createOffer(nftAddress, tokenID, payToken, quantity, pricePerItem, deadline, web3Client, contract = process.env.VUE_APP_HARMONY_MARKETPLACE_CONTRACT_ADDRESS) {
 ...
 * @return {{to: address, data: string, value string}}
 */
 function cancelOffer(nftAddress, tokenID, web3Client, contract = process.env.VUE_APP_HARMONY_MARKETPLACE_CONTRACT_ADDRESS) {
 ...
 * @return {{to: address, data: string, value string}}
 */
 function acceptOffer(nftAddress, tokenID, creator, web3Client, contract = process.env.VUE_APP_HARMONY_MARKETPLACE_CONTRACT_ADDRESS) {
 ...
 * @return {{to: address, data: string, value string}}
 */
 function listItem(nftAddress, tokenID, quantity, payToken, pricePerItem, startingTime, web3Client, contract = process.env.VUE_APP_HARMONY_MARKETPLACE_CONTRACT_ADDRESS) {
 ...
 * @return {{to: address, data: string, value string}}
 */
 function cancelListing(nftAddress, tokenID, web3Client, contract = process.env.VUE_APP_HARMONY_MARKETPLACE_CONTRACT_ADDRESS) {
 ...
 * @return {{to: address, data: string, value string}}
 */
 function updateListing(nftAddress, tokenID, payToken, newPricePerItem, web3Client, contract = process.env.VUE_APP_HARMONY_MARKETPLACE_CONTRACT_ADDRESS) {
 ...
 * @return {{to: address, data: string, value string}}
 */
 function buyListedItemWithPayToken(nftAddress, tokenID, ownerAddress, payToken, web3Client, contract = process.env.VUE_APP_HARMONY_MARKETPLACE_CONTRACT_ADDRESS) {
 ...
 * @return {{to: address, data: string, value string}}
 */
 function createAuction(nftAddress, tokenID, payToken, reservePrice, startTimestamp, endTimestamp, minBidReserve, web3Client, contract = process.env.VUE_APP_HARMONY_AUCTION_CONTRACT_ADDRESS) {
 ...
 * @param {string} [contract] Contract address
 */
 function placeAuctionBid(nftAddress, tokenID, amount, web3Client, contract = process.env.VUE_APP_HARMONY_AUCTION_CONTRACT_ADDRESS) {
 ...
 * @param {string} [contract] Contract address
 */
 function withdrawAuctionBid(nftAddress, tokenID, web3Client, contract = process.env.VUE_APP_HARMONY_AUCTION_CONTRACT_ADDRESS) {
 ...
 * @param {string} [contract] Contract address
 */
 function resultAuction(nftAddress, tokenID, web3Client, contract = process.env.VUE_APP_HARMONY_AUCTION_CONTRACT_ADDRESS) {
 ...
 * @param {string} [contract] Contract address
 */
function resultFailedAuction(nftAddress, tokenID, web3Client, contract = process.env.VUE_APP_HARMONY_AUCTION_CONTRACT_ADDRESS) {
 ...
 * @param {string} [contract] Contract address
 */
 function cancelAuction(nftAddress, tokenID, web3Client, contract = process.env.VUE_APP_HARMONY_AUCTION_CONTRACT_ADDRESS) {
 ...
 * @param {string} [contract] Contract address
 */
 function updateAuctionReservePrice(nftAddress, tokenID, reservePrice, web3Client, contract = process.env.VUE_APP_HARMONY_AUCTION_CONTRACT_ADDRESS) {
 ...
 * @param {string} [contract] Contract address
 */
 function updateAuctionStartTime(nftAddress, tokenID, startTime, web3Client, contract = process.env.VUE_APP_HARMONY_AUCTION_CONTRACT_ADDRESS) {
 ...
 * @param {string} [contract] Contract address
 */
 function updateAuctionEndTime(nftAddress, tokenID, endTime, web3Client, contract = process.env.VUE_APP_HARMONY_AUCTION_CONTRACT_ADDRESS) {
